...
The public skill repository excludes generated evidence files. Keep verification
notes in the PR, issue, or local scratch space used for the skill update, and
run `scripts/verify_skill_evidence.sh .` before publishing to confirm the
checked-in skill remains self-contained.
